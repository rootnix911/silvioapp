...
public function getServersList()
    {
        $serversArray = CHtml::listData(Server::model()->findAll(), 'server', 'server');
        return $serversArray;
    }
...
public function getPortList()
    {
        $portsArray = CHtml::listData(Port::model()->findAll(), 'port', 'port');
        return $portsArray;
    }

public function getTemplateList()
    {
        $templateArray = CHtml::listData(Template::model()->findAll(), 'id', 'title', 'template');
        return $templateArray;
    }
public function getClientsList()
    {
	$clientsArray = CHtml::listData(Clients::model()->findAll(), 'username', 'username');
	return $clientsArray;
    }
