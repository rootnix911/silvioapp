...
class VideoController extends Controller
{
    ...
    {
        $serversArray = CHtml::listData(Server::model()->findAll(), 'id', 'server');
        return $serversArray;
    }
    ...
    {
        $portsArray = CHtml::listData(Port::model()->findAll(), 'id', 'port');
        return $portsArray;
    }

    public static function getL()
    {
        $models = Server::model()->findAll(array('order'=>'server'));
        return CHtml::listData(models, 'id', 'server');
    }
